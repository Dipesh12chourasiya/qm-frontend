...
const TestDetails = () => {
  ...
  const { loading, test, getTestById } = useTests();
  ...
  const handleStartTest = () => {
    navigate(`/student/tests/${test._id}/system-check`);
  };
      ...
      <div className="bg-white rounded-xl shadow-md p-8 max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="border rounded-lg p-4">
            ...
            <h3 className="text-2xl font-bold">{test.duration} min</h3>
          </div>
          ...
          <div className="border rounded-lg p-4">
            ...
            <h3 className="text-green-600 font-bold">Available</h3>
          </div>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-5 mb-8">
          ...
          <ul className="list-disc ml-5 space-y-2 text-sm">
            ...
            <li>Each test can only be attempted once.</li>
          </ul>
        </div>
